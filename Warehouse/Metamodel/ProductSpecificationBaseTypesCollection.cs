...
namespace Hsrm.DeepModeling.Warehouse.Warehouse
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the ProductSpecification class
    /// </summary>
    public class ProductSpecificationBaseTypesCollection : ICollectionExpression<NMF.Models.Meta.IClass>, ICollection<NMF.Models.Meta.IClass>
    {
        
        private IProductSpecification _parent;
        
        private static NMF.Models.Meta.IClass[] _standardValues = new NMF.Models.Meta.IClass[] {
                ((NMF.Models.Meta.IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("https://multi-workshop.github.io/warehouse/nmeta#//IndividualProduct")))};
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public ProductSpecificationBaseTypesCollection(IProductSpecification parent)
        {
            this._parent = parent;
        }
        ...
        {
            if (ProductSpecificationBaseTypesCollection._standardValues.Contains(item))
            {
                return true;
            }
            return false;
        ...
        {
            ProductSpecificationBaseTypesCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return ProductSpecificationBaseTypesCollection._standardValues.Cast<NMF.Models.Meta.IClass>().GetEnumerator();
        }

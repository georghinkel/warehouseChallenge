...
namespace Hsrm.DeepModeling.Warehouse.Warehouse
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the BulkProductSpecification class
    /// </summary>
    public class BulkProductSpecificationBaseTypesCollection : ICollectionExpression<NMF.Models.Meta.IClass>, ICollection<NMF.Models.Meta.IClass>
    {
        
        private IBulkProductSpecification _parent;
        
        private static NMF.Models.Meta.IClass[] _standardValues = new NMF.Models.Meta.IClass[] {
                ((NMF.Models.Meta.IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("https://multi-workshop.github.io/warehouse/nmeta#//BulkProduct")))};
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public BulkProductSpecificationBaseTypesCollection(IBulkProductSpecification parent)
        {
            this._parent = parent;
        }
        ...
        {
            if (BulkProductSpecificationBaseTypesCollection._standardValues.Contains(item))
            {
                return true;
            }
            return false;
        ...
        {
            BulkProductSpecificationBaseTypesCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return BulkProductSpecificationBaseTypesCollection._standardValues.Cast<NMF.Models.Meta.IClass>().GetEnumerator();
        }

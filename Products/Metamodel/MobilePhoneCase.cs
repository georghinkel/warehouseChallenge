...
namespace Hsrm.DeepModeling.Warehouse.Products.MyWarehouse
{
    ...
    /// <summary>
    /// The default implementation of the MobilePhoneCase class
    /// </summary>
    [XmlNamespaceAttribute("https://example.org")]
    [XmlNamespacePrefixAttribute("ex")]
    [ModelRepresentationClassAttribute("https://example.org/#//MobilePhoneCase")]
    [DebuggerDisplayAttribute("MobilePhoneCase {Name}")]
    public partial class MobilePhoneCase : Hsrm.DeepModeling.Warehouse.Warehouse.IndividualProduct, IMobilePhoneCase, NMF.Models.IModelElement
    {
        ...
        public new static Hsrm.DeepModeling.Warehouse.Warehouse.IProductSpecification ProductSpecificationInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("https://example.org/#//MobilePhoneCase")));
                }

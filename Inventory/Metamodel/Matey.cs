...
namespace Hsrm.DeepModeling.Warehouse.Products.Products
{
    ...
    /// <summary>
    /// The default implementation of the Matey class
    /// </summary>
    ...
    public partial class Matey : Hsrm.DeepModeling.Warehouse.Warehouse.SaleItem, IMatey, NMF.Models.IModelElement
    {
        ...
        public new static Hsrm.DeepModeling.Warehouse.Warehouse.IIndividualProduct IndividualProductInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("https://example.org/products#//Matey")));
                }

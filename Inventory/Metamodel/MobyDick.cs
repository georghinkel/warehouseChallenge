...
namespace Hsrm.DeepModeling.Warehouse.Products.Products
{
    ...
    /// <summary>
    /// The default implementation of the Moby Dick class
    /// </summary>
    [XmlNamespaceAttribute("https://example.org/products")]
    [XmlNamespacePrefixAttribute("p")]
    [ModelRepresentationClassAttribute("https://example.org/products#//Moby%20Dick")]
    [XmlElementNameAttribute("Moby Dick")]
    public partial class MobyDick : Hsrm.DeepModeling.Warehouse.Warehouse.SaleItem, IMobyDick, NMF.Models.IModelElement
    {
        ...
        public new static Hsrm.DeepModeling.Warehouse.Warehouse.IIndividualProduct IndividualProductInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("https://example.org/products#//Moby%20Dick")));
                }

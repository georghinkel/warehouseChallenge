...
namespace Hsrm.DeepModeling.Warehouse.Products.Products
{
    ...
    /// <summary>
    /// The default implementation of the Mate0815 class
    /// </summary>
    ...
    public partial class Mate0815 : Hsrm.DeepModeling.Warehouse.Warehouse.SaleItem, IMate0815, NMF.Models.IModelElement
    {
        ...
        public new static Hsrm.DeepModeling.Warehouse.Warehouse.IIndividualProduct IndividualProductInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("https://example.org/products#//Mate0815")));
                }
